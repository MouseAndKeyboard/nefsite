...
export default [
  ...
  createData("Statistical Science", "STAT3062", "-", "-"),
  createData("Random Processes and their Applications", "STAT3061", "-", "-"),
  createData("Natural Langugage Processing", "CITS4012", "-", "-"),
  createData("Algebraic Structures and Symmetry", "MATH3031", "-", "-"),
]
